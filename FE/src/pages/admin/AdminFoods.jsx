  ...
  const handleProductUpdate = async (event) => {
    ...
    try {
      const payload = {
        ...
        food_type: editingProduct.food_type,
      ...
      await adminApi.updateProduct(editingProduct.product_id, payload)
